...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center fixed-top topbar-transparent">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-center justify-content-lg-start">
      ...
      <i class="bi bi-clock ms-4 d-none d-lg-flex align-items-center"><span>Mon-Sat: 09:00 AM - 05:00 PM</span></i>
    </div>
  </section>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <div class="logo me-auto">
        <h1><a href="/">{{ config('app.name', 'Abuelo\'s Delicatessen') }}</a></h1>
      ...
      <a href="/cart" class="book-a-table-btn scrollto"><i class="bi bi-cart4"></i> Cart</a>
    ...
    <div class="hero-container">
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background-image: url({{asset('/img/slide/steak.jpg')}});">
          ...
          <!-- Slide 2 -->
          <div class="carousel-item" style="background-image: url({{asset('/img/slide/scallops.jpg')}});">
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <!-- Slide 3 -->
          <div class="carousel-item" style="background-image: url({{asset('/img/slide/oysters.jpg')}});">
            <div class="carousel-container">
              <div class="carousel-content">
  ...
  <main id="main">
    ...
    <section id="menu" class="menu">
      ...
      @livewire('check-our-product-component')
